...
```{r sites-table, echo=FALSE,message=FALSE,warning=FALSE}
library(flextable)
...
tl<-align(tl, i = NULL, j =(2:5) , align = "center", part = "all")%>%
  ...
  width(j=6, width=1.5)%>%
  set_caption("Table:(\\#tab:sites-table) Wallkill River (WALK) sampling locations. Locations are ordered from upstream to downstream according to river mile and mainstem confluence")
tl
```
