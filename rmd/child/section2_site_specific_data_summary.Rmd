...
calcs.df<-calcs.df %>% 
  mutate(calc_value=case_when(
    ...
    chemical_name %in% "nitrogen, ammonia (as n)"~2,
    #this is a placeholder for nitrogen, this one might be really difficult-it's a lookup table based on WQ standard, ph and temp! actually this might not apply, since fish propagation and survival isn't a thing anymore? it's fishing.
