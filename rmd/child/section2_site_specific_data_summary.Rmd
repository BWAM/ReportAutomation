...
stds<-stds %>% 
  rename("SH_WQ_STANDARD"=classifcation,
...
chem_short.df<-chem.df %>% 
  select(SITE_ID,sample_date,SH_WQ_STANDARD,chemical_name,result_value,corrected_value,result_unit,threshold,t,direction) %>% 
