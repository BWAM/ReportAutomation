...
tl.1<-align(tl.1, i = NULL, j =(2:10) , align = "center", part = "all")%>%
  set_caption(caption="Table:(\\#tab:Analytes) Water chemistry analytes sampled as part of the Ramapo River Stream Assessment Survey. Table lists sampled analytes and analytical specifications. ^ Precision objectives are defined by results of duplicate samples as described in Appendix III")
tl.1
...
```{r chem1, fig.height=6,fig.width=6,message=FALSE,warning=FALSE, echo=FALSE, fig.cap="The X-axis presents sampling locations from upstream to downstream and axis labels correspond with Table 1, Figure 1 and Figure 2. The y-axis represents base log10 analyte concentrations. Point symbols match with WI/PWL segmentation as indicated in the plot legend. The total number of reported values illustrated for each sampling location can vary due to non-detection and QA/QC procedures. Descriptions of removed records are presented in Appendix III." }
chem.graph(chem.trans)  

```

```{r chem.2, echo=FALSE, fig.width=5, fig.height=6, message=FALSE, warning=FALSE, fig.cap="The X-axis presents sampling locations from upstream to downstream and axis labels correspond with Table 1, Figure 1 and Figure 2. The y-axis represents base log10 analyte concentrations. Point symbols match with WI/PWL segmentation as indicated in the plot legend. The total number of reported values illustrated for each sampling location can vary due to non-detection and QA/QC procedures. Descriptions of removed records are presented in Appendix III." }
