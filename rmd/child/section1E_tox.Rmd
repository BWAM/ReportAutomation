...
```{r Tox-table, echo=FALSE, message=FALSE,warning=FALSE}
#call table function
table.f(tox.tbl,2,7)%>%
  flextable::fontsize(size = 10, part = "all")%>%
  flextable::width(j=4:7, width=1.2)%>%
  set_caption("Table: (\\#tab:Tox-table) Wallkill River Microtox® sediment and porewater toxicity results for select locations in the Wallkill River Survey. Sediment samples were collected for toxicity testing in baseflow conditions during macroinvertebrate community collection at sampling locations.")
