...
Results from Microtox® Acute Toxicity Test for Sediments, Porewaters and Effluents collected in 2017 are found in (@ref tab.id="Tox-table"). In the Wallkill Watershed, sediments ranged from non-toxic to severe and porewaters ranged from non-toxic to toxic. 
