...
```{r site-map, fig.cap="Map of Wallkill River (WALK) sampling locations. Site names reference the Location ID and River Mile presented in Table\@ref(tab:sites-table)", echo=FALSE, message=FALSE, warning=FALSE,fig.width=7,fig.height=8}
